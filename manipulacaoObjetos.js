...
function limpaAtributo(obj, atributo){
    const copiaObj = Object.assign({}, obj) // const copiaObj = {...objeto}
    delete copiaObj[atributo]
    return copiaObj
}

let copiaPessoa = limpaAtributo (pessoa, "idade") // let copiaPessoa = limpaAtributo({nome: 'Marina', idade: 29}, "nome")
console.log(copiaPessoa)
console.log (pessoa)

//tem que passar o atributo como string
